...
x_cobra = largura/2 # essa maneira faz com que o obj dique no meio da tela: largura_tela/2 - largura_obj/2
y_cobra = altura/2
...
while True:
    ...
    for event in pygame.event.get():
        ...
        if pontos == 10:
           ...
           mensagem64 = 'asdadsdad'
           texto_formatado64 = fonte3.render(mensagem, True, (0,0,0))
